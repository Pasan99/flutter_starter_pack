  ...
  Future<Responses> getItems(String cityId, GpsCoordinates gpsCoordinates,
    ...
    try {
      ...
      List<StoreResponseApi> result = await request.getList(
          APIConstants.BASE_URL + APIConstants.API_GET_STORES_BY_CITY + url,
          context,
          authToken: "",
          body: "",
      ...
      if (stores.isNotEmpty && stores[0].errorBody == null) {
        // Set Store Names
...
//    }
  ...
  Future<bool> loadMore() async {
    ...
    if (selectedUser != null) {
      response = await getItems(selectedUser.cityId, selectedUser.gpsCoordinates, context);
      print("Load More");
    }
