...
import 'package:food_deliver/src/viewmodels/category_based_store_viewmodel.dart';
import 'package:loadmore/loadmore.dart';
import 'package:provider/provider.dart';
import 'package:easy_localization/easy_localization.dart';
import 'package:shimmer/shimmer.dart';

class CategoryBasedStoreSelectionPage extends StatelessWidget {
...
//      ),
      body: ChangeNotifierProvider(
        create: (context) =>
            CategoryBasedStoreViewModel(categoryResponseApi: categoriesModel),
          ...
          child: Column(
            children: <Widget>[
              Stack(
                children: <Widget>[
                  CachedNetworkImage(
                    imageUrl: categoriesModel.imageUrl != null
              ...
              Material(
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Consumer<CategoryBasedStoreViewModel>(
...
//                                    body:
//                                        "Changing the location will remove all items from cart. Because stores are displayed based on your location");
                              }
                            },
                          );
                        }
              ...
              Container(
                child: Consumer<CategoryBasedStoreViewModel>(
                    builder: (context, model, child) {
...
class DropDownList extends StatefulWidget {
  ...
  int selectedIndex;
  CategoryBasedStoreViewModel _storeViewModel;
                ...
                if (await CartHelper().getCartItemCount() > 0) {
                  PopupDialogs.showPosterPopUpWithAction(
                      ...
                      onClickAction: () async {
                        // on agree
                        if (value.personName ==
                            CategoryBasedStoreViewModel.DELIVER_TO_SOMEONE) {
                      ...
                      image: "assets/images/empty_cart_illustration.png",
